...
def push(arg0, arg1, mainMemory, pc):
	...
	mainMemory.stack.insert((abs(mainMemory.registers['esp']))/4, val_arg0)
...
def pushf(arg0, arg1, mainMemory, pc):
	mainMemory.stack.insert((abs(mainMemory.registers['esp']))/4, mainMemory.registers['flags'])
	mainMemory.registers['esp'] -= 4
...
def call(arg0, arg1, mainMemory, pc):
	if arg0+':' in pc.labels:
		mainMemory.stack.insert((abs(mainMemory.registers['esp']))/4,(pc.curr_label, pc.inst_num))
		mainMemory.registers['esp'] -= 4
		pc.curr_label = arg0+':'
		pc.inst_num = -1
